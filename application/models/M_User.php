...
class M_User extends CI_Model
{
    ...
    var $column_search = array('fullname', 'section_name', 'departement_name', 'division_name', 'position_name'); //set column field database for datatable searchable 
    var $order = array('id_user' => 'ASC'); // default order 

    private function _get_datatables_query()
    {
        // $this->db->select('u.*,section_name,departement_name,division_name,position_name')
